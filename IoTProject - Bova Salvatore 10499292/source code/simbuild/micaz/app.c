...
#line 741
typedef int (*__compar_fn_t)(const void *arg_0xb7ba1458, const void *arg_0xb7ba15f0);
#line 779
__extension__ 
#line 796
__extension__ 
...
#line 260
extern double erfc(double arg_0xb7b528c8) __attribute((__leaf__)) __attribute((__nothrow__)) ;
#line 336
__extension__ 
...
unsigned int (*hashfunction)(void *arg_0xb79fc840), 
int (*key_eq_fn)(void *arg_0xb79fcc88, void *arg_0xb79fce00));
#line 103
#line 102
int 
...
static inline void RandomInitialise(int arg_0xb78cb9b8, int arg_0xb78cbb10);
static double RandomUniform(void );
...
typedef TMilli sendAckC$waitTimer$precision_tag;
typedef TMilli sendAckC$binTimer$precision_tag;
typedef uint16_t sendAckC$SeedInit$parameter;
typedef TMilli sendAckC$truckTimer$precision_tag;
typedef TMilli sendAckC$toTruckTimer$precision_tag;
typedef TMilli sendAckC$garbageTimer$precision_tag;
...
static void sendAckC$waitTimer$fired(void );
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void sendAckC$fillBin$runTask(void );
# 60 "/opt/tinyos-main-2.1.2/tos/interfaces/Boot.nc"
static void sendAckC$Boot$booted(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$binTimer$fired(void );
...
error_t error);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void sendAckC$truckArrived$runTask(void );
#line 75
static void sendAckC$sendGarbage$runTask(void );
#line 75
static void sendAckC$sendAvailability$runTask(void );
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
uint8_t len);
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void sendAckC$sendMoveMsg$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$truckTimer$fired(void );
#line 83
static void sendAckC$toTruckTimer$fired(void );
# 113 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static void sendAckC$callTruck$runTask(void );
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$garbageTimer$fired(void );
...
# 64 "/opt/tinyos-main-2.1.2/tos/interfaces/ParameterInit.nc"
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$waitTimer$startOneShot(uint32_t dt);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t sendAckC$fillBin$postTask(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$binTimer$startOneShot(uint32_t dt);
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Packet.nc"
...
uint8_t len);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t sendAckC$truckArrived$postTask(void );
#line 67
static error_t sendAckC$sendGarbage$postTask(void );
#line 67
static error_t sendAckC$sendAvailability$postTask(void );
# 64 "/opt/tinyos-main-2.1.2/tos/interfaces/ParameterInit.nc"
static error_t sendAckC$SeedInit$init(sendAckC$SeedInit$parameter param);
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t sendAckC$sendMoveMsg$postTask(void );
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$truckTimer$startOneShot(uint32_t dt);
#line 64
static void sendAckC$toTruckTimer$startPeriodic(uint32_t dt);
#line 78
static void sendAckC$toTruckTimer$stop(void );
# 104 "/opt/tinyos-main-2.1.2/tos/interfaces/SplitControl.nc"
static error_t sendAckC$SerialSplitControl$start(void );
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t sendAckC$valueUnits$rand16(void );
# 59 "/opt/tinyos-main-2.1.2/tos/interfaces/PacketAcknowledgements.nc"
...
message_t * msg);
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
static error_t sendAckC$callTruck$postTask(void );
# 88 "/opt/tinyos-main-2.1.2/tos/interfaces/AMPacket.nc"
...
message_t * amsg);
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
static void sendAckC$garbageTimer$startOneShot(uint32_t dt);
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
static uint16_t sendAckC$valueTimer$rand16(void );
# 60 "sendAckC.nc"
...
#line 60
typedef int sendAckC$__nesc_sillytask_fillBin[sendAckC$fillBin];
enum sendAckC$__nesc_unnamed4338 {
#line 61
  sendAckC$callTruck = 7U
};
#line 61
typedef int sendAckC$__nesc_sillytask_callTruck[sendAckC$callTruck];
enum sendAckC$__nesc_unnamed4339 {
#line 62
  sendAckC$truckArrived = 8U
};
#line 62
typedef int sendAckC$__nesc_sillytask_truckArrived[sendAckC$truckArrived];
enum sendAckC$__nesc_unnamed4340 {
#line 63
  sendAckC$sendMoveMsg = 9U
};
#line 63
typedef int sendAckC$__nesc_sillytask_sendMoveMsg[sendAckC$sendMoveMsg];
enum sendAckC$__nesc_unnamed4341 {
#line 64
  sendAckC$sendAvailability = 10U
};
#line 64
typedef int sendAckC$__nesc_sillytask_sendAvailability[sendAckC$sendAvailability];
enum sendAckC$__nesc_unnamed4342 {
#line 65
  sendAckC$sendGarbage = 11U
};
#line 65
typedef int sendAckC$__nesc_sillytask_sendGarbage[sendAckC$sendGarbage];
#line 46
uint8_t sendAckC$rec_id[1000];
message_t sendAckC$packet[1000];
uint8_t sendAckC$capacity[1000];
uint8_t sendAckC$garbage[1000];
uint8_t sendAckC$x[1000];
uint8_t sendAckC$y[1000];
uint8_t sendAckC$distance[1000];
uint8_t sendAckC$minDistance[1000];
uint8_t sendAckC$normal_status[1000];
uint8_t sendAckC$randomTimer[1000];
uint8_t sendAckC$drop[1000];
uint8_t sendAckC$mess_type[1000];
uint8_t sendAckC$closestNeighbour[1000];
...
static inline void sendAckC$sendMoveMsg$runTask(void );
#line 86
static inline void sendAckC$truckArrived$runTask(void );
#line 102
static inline void sendAckC$callTruck$runTask(void );
#line 134
static inline void sendAckC$sendAvailability$runTask(void );
#line 165
static inline void sendAckC$fillBin$runTask(void );
#line 193
...
#line 248
static inline void sendAckC$garbageTimer$fired(void );
...
static inline void sendAckC$truckTimer$fired(void );
...
static inline void sendAckC$toTruckTimer$fired(void );
...
static inline void sendAckC$binTimer$fired(void );
...
static inline void sendAckC$waitTimer$fired(void );
...
#line 364
static inline void sendAckC$sendGarbage$runTask(void );
# 53 "/opt/tinyos-main-2.1.2/tos/chips/atm128/timer/HplAtm128TimerCtrl8.nc"
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t sendAckC$fillBin$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(sendAckC$fillBin);
#line 67
...
# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$binTimer$startOneShot(uint32_t dt){
#line 73
...
inline static void sendAckC$toTruckTimer$stop(void ){
#line 78
...
#line 78
#line 73
inline static void sendAckC$truckTimer$startOneShot(uint32_t dt){
#line 73
...
#line 317
  sendAckC$mess_type[sim_node()] = __nesc_ntoh_uint8(mess->msg_type.nxdata);

  if (sendAckC$mess_type[sim_node()] == 1 && TOS_NODE_ID == 1) {
      if (sendAckC$drop[sim_node()] == 0) {
          sendAckC$rec_id[sim_node()] = __nesc_ntoh_uint16(mess->node_id.nxdata);
          sim_log_debug(198U, "radio_rec", "Message received from bin %d at time %s \n", sendAckC$rec_id[sim_node()], sim_time_string());
          sim_log_debug(199U, "radio_rec", "Computing distance... \n");
          sendAckC$distance[sim_node()] = sqrt(pow(__nesc_ntoh_uint16(mess->node_x.nxdata) - sendAckC$x[sim_node()], 2) + pow(__nesc_ntoh_uint16(mess->node_y.nxdata) - sendAckC$y[sim_node()], 2));
          sim_log_debug(200U, "radio_rec", "distance: %d\n", sendAckC$distance[sim_node()]);
          sendAckC$truckTimer$startOneShot(sendAckC$distance[sim_node()] * 1000);
          sendAckC$drop[sim_node()] = 1;
          sendAckC$x[sim_node()] = __nesc_ntoh_uint16(mess->node_x.nxdata);
          sendAckC$y[sim_node()] = __nesc_ntoh_uint16(mess->node_y.nxdata);
        }
      else {
          sim_log_debug(201U, "radio_rec", "Message dropped... at time %s \n", sim_time_string());
        }
    }
  else {
#line 335
    if (sendAckC$mess_type[sim_node()] == 2 && TOS_NODE_ID == __nesc_ntoh_uint16(mess->node_receiver.nxdata)) {
        sendAckC$toTruckTimer$stop();
        sendAckC$capacity[sim_node()] = 0;
      }
    else {
#line 339
      if (sendAckC$mess_type[sim_node()] == 3 && TOS_NODE_ID != 1) {
          if (sendAckC$normal_status[sim_node()] == 0) {
              sendAckC$binTimer$startOneShot(1500);
              sendAckC$rec_id[sim_node()] = __nesc_ntoh_uint16(mess->node_id.nxdata);
              sim_log_debug(202U, "radio_rec", "REQUEST FOR HELP RECEIVED\n");
            }
        }
      else {
#line 346
        if (sendAckC$mess_type[sim_node()] == 4 && TOS_NODE_ID != 1) {
            sendAckC$distance[sim_node()] = sqrt(pow(__nesc_ntoh_uint16(mess->node_x.nxdata) - sendAckC$x[sim_node()], 2) + pow(__nesc_ntoh_uint16(mess->node_y.nxdata) - sendAckC$y[sim_node()], 2));
            if (sendAckC$minDistance[sim_node()] > sendAckC$distance[sim_node()]) {
                sendAckC$closestNeighbour[sim_node()] = __nesc_ntoh_uint16(mess->node_id.nxdata);
                sendAckC$minDistance[sim_node()] = sendAckC$distance[sim_node()];
              }
          }
        else {
#line 353
          if (sendAckC$mess_type[sim_node()] == 5 && TOS_NODE_ID != 1) {
              sendAckC$garbage[sim_node()] = __nesc_ntoh_uint16(mess->tot_garbage.nxdata);
              sim_log_debug(203U, "radio_rec", "NODE: %d received: %d... at time %s \n", TOS_NODE_ID, sendAckC$garbage[sim_node()], sim_time_string());
              sendAckC$fillBin$postTask();
            }
          }
        }
      }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Receive$receive(am_id_t arg_0xb7648298, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
  switch (arg_0xb7648298) {
#line 78
    case 6:
#line 78
...
#line 78
    default:
#line 78
      __nesc_result = TossimActiveMessageC$Receive$default$receive(arg_0xb7648298, msg, payload, len);
#line 78
      break;
#line 78
    }
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * TossimActiveMessageC$Snoop$receive(am_id_t arg_0xb7648930, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = TossimActiveMessageC$Snoop$default$receive(arg_0xb7648930, msg, payload, len);
#line 78
...
# 78 "/opt/tinyos-main-2.1.2/tos/interfaces/Receive.nc"
inline static message_t * SerialActiveMessageC$Receive$receive(am_id_t arg_0xb752ff00, message_t * msg, void * payload, uint8_t len){
#line 78
  nx_struct message_t *__nesc_result;
#line 78

#line 78
    __nesc_result = SerialActiveMessageC$Receive$default$receive(arg_0xb752ff00, msg, payload, len);
#line 78
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t sendAckC$valueTimer$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 52
# 62 "/opt/tinyos-main-2.1.2/tos/system/RandomMlcgC.nc"
static inline error_t RandomMlcgC$SeedInit$init(uint16_t s)
#line 62
{
  { __nesc_atomic_t __nesc_atomic = __nesc_atomic_start();
#line 63
    RandomMlcgC$seed[sim_node()] = (uint32_t )(s + 1);
#line 63
...
# 64 "/opt/tinyos-main-2.1.2/tos/interfaces/ParameterInit.nc"
inline static error_t sendAckC$SeedInit$init(sendAckC$SeedInit$parameter param){
#line 64
  unsigned char __nesc_result;
#line 64
...
#line 205
{
  if (err == SUCCESS) {
      ...
      sendAckC$SeedInit$init(TOS_NODE_ID + sim_time_string());
      sendAckC$x[sim_node()] = sendAckC$valueTimer$rand16() % 100;
      sendAckC$y[sim_node()] = sendAckC$valueTimer$rand16() % 100;
      sim_log_debug(188U, "role", "I'm node %d, my position is x = %d , y = %d\n", TOS_NODE_ID, sendAckC$x[sim_node()], sendAckC$y[sim_node()]);

      if (TOS_NODE_ID != 1) {
          sendAckC$randomTimer[sim_node()] = sendAckC$valueTimer$rand16() % 30 + 1;
          sim_log_debug(189U, "role", "I'm node %d: my first random timer is: %d\n", TOS_NODE_ID, sendAckC$randomTimer[sim_node()]);
          sendAckC$garbageTimer$startOneShot(sendAckC$randomTimer[sim_node()] * 1000);
        }
    }
  else {
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void TossimActiveMessageC$AMSend$sendDone(am_id_t arg_0xb76598b0, message_t * msg, error_t error){
#line 110
  /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$sendDone(arg_0xb76598b0, msg, error);
#line 110
}
#line 110
...
# 110 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static void SerialActiveMessageC$AMSend$sendDone(am_id_t arg_0xb752f540, message_t * msg, error_t error){
#line 110
  switch (arg_0xb752f540) {
#line 110
    case AM_SERIAL_MSG:
#line 110
...
#line 110
    default:
#line 110
      SerialActiveMessageC$AMSend$default$sendDone(arg_0xb752f540, msg, error);
#line 110
      break;
#line 110
    }
...
# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t sendAckC$sendMoveMsg$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(sendAckC$sendMoveMsg);
#line 67
...
# 64 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$toTruckTimer$startPeriodic(uint32_t dt){
#line 64
...
#line 165
{
  ...
  sim_log_debug(182U, "role", "Somebody threw away %d units!\n", sendAckC$garbage[sim_node()]);
  if (sendAckC$capacity[sim_node()] + sendAckC$garbage[sim_node()] < 85) {
      sendAckC$normal_status[sim_node()] = 0;
      sendAckC$capacity[sim_node()] += sendAckC$garbage[sim_node()];
      sim_log_debug(183U, "role", "Inside me there are: %d units\n", sendAckC$capacity[sim_node()]);
    }
  else {
#line 173
    if (sendAckC$capacity[sim_node()] + sendAckC$garbage[sim_node()] >= 85 && sendAckC$capacity[sim_node()] + sendAckC$garbage[sim_node()] < 100) {
        sendAckC$normal_status[sim_node()] = 1;
        sendAckC$capacity[sim_node()] += sendAckC$garbage[sim_node()];
        sim_log_debug(184U, "role", "Inside me (%d) there are %d units, I can still collect stuff but I will be full soon... Let's call the truck!\n", TOS_NODE_ID, sendAckC$capacity[sim_node()]);

        sendAckC$toTruckTimer$startPeriodic(5000);
      }
    else {
        sim_log_debug(185U, "role", "I can't collect anymore stuff :( I have to send it to my neighbors...\n");

        sendAckC$sendMoveMsg$postTask();
      }
    }

  sendAckC$randomTimer[sim_node()] = sendAckC$valueTimer$rand16() % 30 + 1;
  sim_log_debug(186U, "role", "My new random timer is: %d\n", sendAckC$randomTimer[sim_node()]);
  sendAckC$garbageTimer$startOneShot(sendAckC$randomTimer[sim_node()] * 1000);
}
...
#line 106
  ...
  __nesc_hton_uint16(mess->node_id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->node_x.nxdata, sendAckC$x[sim_node()]);
  __nesc_hton_uint16(mess->node_y.nxdata, sendAckC$y[sim_node()]);

  sim_log_debug(157U, "radio_send", "Try to send a request to the truck at time %s \n", sim_time_string());


  if (sendAckC$AMSend$send(1, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(158U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug(159U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(160U, "radio_pack", "\t Source: %hhu \n ", sendAckC$AMPacket$source(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(161U, "radio_pack", "\t Destination: %hhu \n ", sendAckC$AMPacket$destination(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(162U, "radio_pack", "\t AM Type: %hhu \n ", sendAckC$AMPacket$type(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(163U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(164U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(165U, "radio_pack", "\t\t node_id: %hhu \n", __nesc_ntoh_uint16(mess->node_id.nxdata));
      sim_log_debug_clear(166U, "radio_pack", "\t\t position x of the node: %hhu \n", __nesc_ntoh_uint16(mess->node_x.nxdata));
      sim_log_debug_clear(167U, "radio_pack", "\t\t position y of the node: %hhu \n", __nesc_ntoh_uint16(mess->node_y.nxdata));
      sim_log_debug_clear(168U, "radio_send", "\n ");
      sim_log_debug_clear(169U, "radio_pack", "\n");
    }
}
...
#line 89
  ...
  __nesc_hton_uint16(mess->node_receiver.nxdata, sendAckC$rec_id[sim_node()]);

  sendAckC$PacketAcknowledgements$requestAck(&sendAckC$packet[sim_node()]);
  if (sendAckC$AMSend$send(sendAckC$rec_id[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(156U, "radio_send", "Packet passed to lower layer successfully!\n");
    }
  sendAckC$drop[sim_node()] = 0;
}

# 73 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void sendAckC$waitTimer$startOneShot(uint32_t dt){
#line 73
...
#line 72
  ...
  if (sendAckC$AMSend$send(AM_BROADCAST_ADDR, &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      sim_log_debug(153U, "radio_send", "Packet passed to lower layer successfully!\n");
      sim_log_debug_clear(154U, "radio_pack", "\t Source: %hhu \n ", sendAckC$AMPacket$source(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(155U, "radio_pack", "\t Destination: %hhu \n", sendAckC$AMPacket$destination(&sendAckC$packet[sim_node()]));

      sendAckC$waitTimer$startOneShot(2000);
    }
}
...
#line 138
  __nesc_hton_uint8(mess->msg_type.nxdata, 4);
  __nesc_hton_uint16(mess->node_id.nxdata, TOS_NODE_ID);
  __nesc_hton_uint16(mess->node_x.nxdata, sendAckC$x[sim_node()]);
  __nesc_hton_uint16(mess->node_y.nxdata, sendAckC$y[sim_node()]);
  ...
  if (sendAckC$AMSend$send(sendAckC$rec_id[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
      ...
      sim_log_debug_clear(172U, "radio_pack", "\t Source: %hhu \n ", sendAckC$AMPacket$source(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(173U, "radio_pack", "\t Destination: %hhu \n ", sendAckC$AMPacket$destination(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(174U, "radio_pack", "\t AM Type: %hhu \n ", sendAckC$AMPacket$type(&sendAckC$packet[sim_node()]));
      sim_log_debug_clear(175U, "radio_pack", "\t\t Payload \n");
      sim_log_debug_clear(176U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint8(mess->msg_type.nxdata));
      sim_log_debug_clear(177U, "radio_pack", "\t\t node_id: %hhu \n", __nesc_ntoh_uint16(mess->node_id.nxdata));
      sim_log_debug_clear(178U, "radio_pack", "\t\t position x of the node: %hhu \n", __nesc_ntoh_uint16(mess->node_x.nxdata));
      sim_log_debug_clear(179U, "radio_pack", "\t\t position y of the node: %hhu \n", __nesc_ntoh_uint16(mess->node_y.nxdata));
      sim_log_debug_clear(180U, "radio_send", "\n ");
...
#line 366
  if (sendAckC$closestNeighbour[sim_node()] == 0) {
      sim_log_debug(204U, "radio_rec", "No one is available, I have to drop the garbage\n");
    }
  else {
      sim_log_debug(205U, "radio_rec", "I'm sending my garbage to %d\n", sendAckC$closestNeighbour[sim_node()]);
      __nesc_hton_uint8(mess->msg_type.nxdata, 5);
      __nesc_hton_uint16(mess->node_id.nxdata, TOS_NODE_ID);
      __nesc_hton_uint16(mess->tot_garbage.nxdata, sendAckC$garbage[sim_node()]);
      sim_log_debug(206U, "radio_send", "Try to send a request to the truck at time %s \n", sim_time_string());


      if (sendAckC$AMSend$send(sendAckC$closestNeighbour[sim_node()], &sendAckC$packet[sim_node()], sizeof(my_msg_t )) == SUCCESS) {
          sim_log_debug(207U, "radio_send", "Packet passed to lower layer successfully!\n");
          sim_log_debug(208U, "radio_pack", ">>>Pack\n \t Payload length %hhu \n", sendAckC$Packet$payloadLength(&sendAckC$packet[sim_node()]));
          sim_log_debug_clear(209U, "radio_pack", "\t Source: %hhu \n ", sendAckC$AMPacket$source(&sendAckC$packet[sim_node()]));
          sim_log_debug_clear(210U, "radio_pack", "\t Destination: %hhu \n ", sendAckC$AMPacket$destination(&sendAckC$packet[sim_node()]));
          sim_log_debug_clear(211U, "radio_pack", "\t AM Type: %hhu \n ", sendAckC$AMPacket$type(&sendAckC$packet[sim_node()]));
          sim_log_debug_clear(212U, "radio_pack", "\t\t Payload \n");
          sim_log_debug_clear(213U, "radio_pack", "\t\t msg_type: %hhu \n ", __nesc_ntoh_uint8(mess->msg_type.nxdata));
          sim_log_debug_clear(214U, "radio_pack", "\t\t garbage sent: %hhu \n", __nesc_ntoh_uint16(mess->tot_garbage.nxdata));
          sendAckC$closestNeighbour[sim_node()] = 0;
        }
    }
}
...
# 100 "/opt/tinyos-main-2.1.2/tos/interfaces/Send.nc"
inline static void /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$sendDone(uint8_t arg_0xb72adca8, message_t * msg, error_t error){
#line 100
  switch (arg_0xb72adca8) {
#line 100
    case 0U:
#line 100
...
#line 100
    default:
#line 100
      /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$Send$default$sendDone(arg_0xb72adca8, msg, error);
#line 100
      break;
#line 100
    }
...
# 75 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static void SimSchedulerBasicP$TaskBasic$runTask(uint8_t arg_0xb7bd9b28){
#line 75
  switch (arg_0xb7bd9b28) {
#line 75
...
#line 75
      break;
#line 75
    case sendAckC$fillBin:
#line 75
      sendAckC$fillBin$runTask();
#line 75
      break;
#line 75
    case sendAckC$callTruck:
#line 75
      sendAckC$callTruck$runTask();
#line 75
      break;
#line 75
    case sendAckC$truckArrived:
#line 75
      sendAckC$truckArrived$runTask();
#line 75
      break;
#line 75
    case sendAckC$sendMoveMsg:
#line 75
      sendAckC$sendMoveMsg$runTask();
#line 75
      break;
#line 75
    case sendAckC$sendAvailability:
#line 75
      sendAckC$sendAvailability$runTask();
#line 75
      break;
#line 75
    case sendAckC$sendGarbage:
#line 75
      sendAckC$sendGarbage$runTask();
#line 75
      break;
#line 75
...
#line 75
    default:
#line 75
      SimSchedulerBasicP$TaskBasic$default$runTask(arg_0xb7bd9b28);
#line 75
      break;
#line 75
    }
...
#line 67
# 80 "/opt/tinyos-main-2.1.2/tos/interfaces/AMSend.nc"
inline static error_t /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$AMSend$send(am_id_t arg_0xb72aa730, am_addr_t addr, message_t * msg, uint8_t len){
#line 80
  unsigned char __nesc_result;
#line 80

#line 80
  __nesc_result = TossimActiveMessageC$AMSend$send(arg_0xb72aa730, addr, msg, len);
#line 80
...
# 52 "/opt/tinyos-main-2.1.2/tos/interfaces/Random.nc"
inline static uint16_t sendAckC$valueUnits$rand16(void ){
#line 52
  unsigned short __nesc_result;
#line 52
...
#line 248
{
  ...
  sim_log_debug(191U, "role", "I'm node %d: my random timer fired at %s\n", TOS_NODE_ID, sim_time_string());
  sendAckC$garbage[sim_node()] = sendAckC$valueUnits$rand16() % 10 + 1;
  sendAckC$fillBin$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t sendAckC$truckArrived$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(sendAckC$truckArrived);
#line 67
...
#line 259
{
  sendAckC$sendSerialPacket(30 + sendAckC$rec_id[sim_node()]);
  sim_log_debug(192U, "role", "I'm the truck and I arrived at bin %d at time %s\n", sendAckC$rec_id[sim_node()], sim_time_string());
  sendAckC$truckArrived$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t sendAckC$callTruck$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(sendAckC$callTruck);
#line 67
...
#line 267
{
  ...
  sendAckC$callTruck$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t sendAckC$sendAvailability$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(sendAckC$sendAvailability);
#line 67
...
#line 276
{
  sendAckC$sendAvailability$postTask();
}

# 67 "/opt/tinyos-main-2.1.2/tos/interfaces/TaskBasic.nc"
inline static error_t sendAckC$sendGarbage$postTask(void ){
#line 67
  unsigned char __nesc_result;
#line 67

#line 67
  __nesc_result = SimSchedulerBasicP$TaskBasic$postTask(sendAckC$sendGarbage);
#line 67
...
#line 284
{
  sendAckC$sendSerialPacket(4);
  sendAckC$sendGarbage$postTask();
}
...
# 83 "/opt/tinyos-main-2.1.2/tos/lib/timer/Timer.nc"
inline static void /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$fired(uint8_t arg_0xb730f3a8){
#line 83
  switch (arg_0xb730f3a8) {
#line 83
    case 0U:
#line 83
      sendAckC$garbageTimer$fired();
#line 83
      break;
#line 83
    case 1U:
#line 83
      sendAckC$truckTimer$fired();
#line 83
      break;
#line 83
    case 2U:
#line 83
      sendAckC$toTruckTimer$fired();
#line 83
      break;
#line 83
    case 3U:
#line 83
      sendAckC$binTimer$fired();
#line 83
      break;
#line 83
    case 4U:
#line 83
      sendAckC$waitTimer$fired();
#line 83
      break;
#line 83
    default:
#line 83
      /*HilTimerMilliC.VirtualizeTimerC*/VirtualizeTimerC$0$Timer$default$fired(arg_0xb730f3a8);
#line 83
      break;
#line 83
    }
...
#line 577
{
  sim_log_debug(241U, "HplAtm128CompareC", "Cancelling compare at 0x%p\n", HplAtm128Timer0AsyncP$compare[sim_node()]);
...
#line 545
{
  if (HplAtm128Timer0AsyncP$overflow[sim_node()] != (void *)0) {
      ...
      sim_log_debug(240U, "HplAtm128Timer0AsyncP", "Cancelling overflow %p.\n", HplAtm128Timer0AsyncP$overflow[sim_node()]);
...
#line 481
{
  if (evt->cancelled) {
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << TOIE0)) != 0) {
          ...
          sim_log_debug(237U, "HplAtm128Timer0AsyncP", "Overflow interrupt at %s\n", sim_time_string());
          INTERRUPT_16();
        }
      else {
          sim_log_debug(238U, "HplAtm128Timer0AsyncP", "Setting overflow bit at %s\n", sim_time_string());
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << TOV0;
        }
...
#line 299
  sim_log_debug(230U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting timer: %hhu\n", newVal);
  if (newVal == curVal) {
      return;
    }
  else {
...
#line 187
{
  sim_log_debug(220U, "HplAtm128Timer0AsyncP", "Beginning compare 0x%p at %s\n", evt, sim_time_string());
  if (evt->cancelled) {
      return;
    }
  else {
...
#line 194
      ...
      if ((atm128RegFile[sim_node()][ATM128_TIMSK] & (1 << OCIE0)) != 0) {
          ...
          sim_log_debug(226U, "HplAtm128Timer0AsyncP", "Compare interrupt @ %s\n", timeStr);
          INTERRUPT_15();
        }
      else {
          atm128RegFile[sim_node()][ATM128_TIFR] |= 1 << OCF0;
...
#line 225
  sim_log_debug(227U, "HplAtm128Timer0AsyncP", "Allocated compare at 0x%p\n", newEvent);
...
#line 91
{
  ...
  sim_log_debug(242U, "AMQueue", "AMQueue: request to send from %hhu (%p): passed checks\n", clientId, msg);
  ...
  if (/*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] >= 1) {
      ...
      sim_log_debug(243U, "AMQueue", "%s: request to send from %hhu (%p): queue empty\n", __FUNCTION__, clientId, msg);
      ...
      if (err != SUCCESS) {
          sim_log_debug(244U, "AMQueue", "%s: underlying send failed.\n", __FUNCTION__);
          /*AMQueueP.AMQueueImplP*/AMQueueImplP$0$current[sim_node()] = 1;
      ...
      sim_log_debug(245U, "AMQueue", "AMQueue: request to send from %hhu (%p): queue not empty\n", clientId, msg);
    }
  return SUCCESS;
}
...
#line 364
{
  sim_log_debug(232U, "HplAtm128Timer0AsyncP", "Setting control to be 0x%hhx\n", x.flat);
...
#line 285
  ...
  sim_log_debug(229U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting timer: %hhu\n", rval);
  return rval;
}
...
#line 457
{
  sim_log_debug(235U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Getting compare: %hhu\n", * (volatile uint8_t *)&atm128RegFile[sim_node()][0x31]);
...
#line 293
{
  if (&sendAckC$packet[sim_node()] == buf && err == SUCCESS) {
      sim_log_debug(193U, "radio_send", "Packet sent to node");
      if (TOS_NODE_ID != 1) {
          sim_log_debug_clear(194U, "radio_ack", "(ack not needed)");
        }
      else {

          if (sendAckC$PacketAcknowledgements$wasAcked(buf)) {
              sim_log_debug_clear(195U, "radio_ack", " %d and ack received", sendAckC$rec_id[sim_node()]);
            }
          else 
#line 303
            {
              sim_log_debug_clear(196U, "radio_ack", "but ack was not received");
            }
        }
...
#line 101
      sim_log_debug(215U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: TIFR is %hhx\n", tifr);
      if ((interrupt_in != 0 && interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) || tifr & (1 << OCF0)) {
          if (interrupt_in < /*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$MINDT) {
              sim_log_debug(216U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: under min: %hhu.\n", interrupt_in);
            }
          else {
              sim_log_debug(217U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: OCF set.\n");
            }
          {
#line 109
            __nesc_atomic_end(__nesc_atomic); 
#line 109
      ...
      if (!/*AlarmCounterMilliP.Atm128AlarmAsyncC.Atm128AlarmAsyncP*/Atm128AlarmAsyncP$0$set[sim_node()]) {
          ...
          sim_log_debug(218U, "Atm128AlarmAsyncP", "Atm128AlarmAsyncP: no alarm set, set at max.\n");
        }
      else 
        {
...
#line 463
{
  sim_log_debug(236U, "HplAtm128Timer0AsyncP", "HplAtm128Timer0AsyncP: Setting compare: %hhu\n", t);
  /* atomic removed: atomic calls only */
#line 465
  {
...
#line 508
{
  ...
  sim_log_debug(239U, "HplAtm128Timer0AsyncP", "Scheduling new overflow for %i at time %llu\n", sim_node(), overflowTime);
...
#line 231
{
  ...
  sim_log_debug(228U, "HplAtm128Timer0AsyncP", "Configuring new compare of %i for %i at time %llu  (@ %llu)\n", (int )compareVal, sim_node(), compareTime, sim_time());
                               ...
                               uintptr_t* addr, size_t* size)
{
  ...
  if (!strcmp(varname, "sendAckC$capacity"))
  {
    *addr = (uintptr_t)&sendAckC$capacity[__nesc_mote];
    *size = sizeof(sendAckC$capacity[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$garbage"))
  {
    *addr = (uintptr_t)&sendAckC$garbage[__nesc_mote];
    *size = sizeof(sendAckC$garbage[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$x"))
  {
    *addr = (uintptr_t)&sendAckC$x[__nesc_mote];
    *size = sizeof(sendAckC$x[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$y"))
  {
    *addr = (uintptr_t)&sendAckC$y[__nesc_mote];
    *size = sizeof(sendAckC$y[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$distance"))
  {
    *addr = (uintptr_t)&sendAckC$distance[__nesc_mote];
    *size = sizeof(sendAckC$distance[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$minDistance"))
  {
    *addr = (uintptr_t)&sendAckC$minDistance[__nesc_mote];
    *size = sizeof(sendAckC$minDistance[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$normal_status"))
  {
    *addr = (uintptr_t)&sendAckC$normal_status[__nesc_mote];
    *size = sizeof(sendAckC$normal_status[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$randomTimer"))
  {
    *addr = (uintptr_t)&sendAckC$randomTimer[__nesc_mote];
    *size = sizeof(sendAckC$randomTimer[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$drop"))
  {
    *addr = (uintptr_t)&sendAckC$drop[__nesc_mote];
    *size = sizeof(sendAckC$drop[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$mess_type"))
  {
    *addr = (uintptr_t)&sendAckC$mess_type[__nesc_mote];
    *size = sizeof(sendAckC$mess_type[__nesc_mote]);
    return 0;
  }
  if (!strcmp(varname, "sendAckC$closestNeighbour"))
  {
    *addr = (uintptr_t)&sendAckC$closestNeighbour[__nesc_mote];
    *size = sizeof(sendAckC$closestNeighbour[__nesc_mote]);
    return 0;
  }
...
static void __nesc_nido_initialise(int __nesc_mote)
{
  ...
  sendAckC$capacity[__nesc_mote] = 0;
  sendAckC$garbage[__nesc_mote] = 0;
  memset((void *)&sendAckC$x[__nesc_mote], 0, sizeof sendAckC$x[__nesc_mote]);
  memset((void *)&sendAckC$y[__nesc_mote], 0, sizeof sendAckC$y[__nesc_mote]);
  memset((void *)&sendAckC$distance[__nesc_mote], 0, sizeof sendAckC$distance[__nesc_mote]);
  sendAckC$minDistance[__nesc_mote] = 100000;
  sendAckC$normal_status[__nesc_mote] = 0;
  memset((void *)&sendAckC$randomTimer[__nesc_mote], 0, sizeof sendAckC$randomTimer[__nesc_mote]);
  sendAckC$drop[__nesc_mote] = 0;
  sendAckC$mess_type[__nesc_mote] = 0;
  sendAckC$closestNeighbour[__nesc_mote] = 0;
